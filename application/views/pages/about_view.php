    ...
    <div class="container">
        ...
        <div class="agileits_team_grids">
            <div class="col-md-3 agileits_team_grid">
                <img src="./dist/images/uploads/ms-jaime.png" alt=" " class="img-responsive" />
                <h4>Ms. Jaime</h4>
                <p>Accounting</p>
            ...
            <div class="col-md-3 agileits_team_grid">
                <img src="./dist/images/uploads/ms-lyn.png" alt=" " class="img-responsive" />
                <h4>Ms. Lyn</h4>
                <p>Accounting</p>
                <ul class="agileits_social_icons agileits_social_icons_team">
                    <li><a href="javascript:void(0)" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            ...
            <div class="col-md-3 agileits_team_grid">
                <img src="./dist/images/uploads/mr-arman.png" alt=" " class="img-responsive" />
                <h4>Mr. Arman</h4>
                <p>Supervisor</p>
                <ul class="agileits_social_icons agileits_social_icons_team">
                    <li><a href="javascript:void(0)" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            ...
            <div class="col-md-3 agileits_team_grid">
                <img src="./dist/images/uploads/ms-joy.png" alt=" " class="img-responsive" />
                <h4>Ms. Joy</h4>
                <p>Agent</p>
                <ul class="agileits_social_icons agileits_social_icons_team">
                    <li><a href="javascript:void(0)" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
...
<div class="testimonials">
    <div class="container">
        ...
        <div class="w3_testimonials_grids">
            <div class="wmuSlider testimonial animated wow slideInUp" data-wow-delay=".5s">
