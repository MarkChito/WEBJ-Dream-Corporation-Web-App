                                        ...
                                        <figure>
                                            <div class="snipcart-item block">
                                                ...
                                                <div class="snipcart-details">
                                                    <input type="submit" value="Add to cart" class="button <?= $this->session->userdata("id") ? "add_to_cart" : "login_or_register" ?>" product_id="<?= $product->id ?>" login_location="<?= $this->session->userdata("current_tab") ?>" />
                                                </div>
                                            </div>
                                        </figure>
                                    </div>
