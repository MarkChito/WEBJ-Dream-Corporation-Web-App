...
class rated_items extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata("current_tab", "admin/rated_items");
        $this->session->set_userdata("title", " - Rated Items");

        $this->load->view('templates/admin_customer/header.php', $data);
        $this->load->view('pages/admin/rated_items_view.php');
