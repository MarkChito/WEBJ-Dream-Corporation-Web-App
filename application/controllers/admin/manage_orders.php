...
class manage_orders extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata("current_tab", "admin/manage_orders");
        $this->session->set_userdata("title", " - Manage Orders");

        $this->load->view('templates/admin_customer/header.php', $data);
        $this->load->view('pages/admin/manage_orders_view.php');
